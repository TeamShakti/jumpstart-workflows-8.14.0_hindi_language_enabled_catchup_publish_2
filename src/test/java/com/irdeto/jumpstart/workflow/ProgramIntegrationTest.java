...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.Program")
@TestProcessFileNames({ "com/irdeto/jumpstart/workflow/Program.bpmn"})
public class ProgramIntegrationTest extends BaseProcessUnitTest {

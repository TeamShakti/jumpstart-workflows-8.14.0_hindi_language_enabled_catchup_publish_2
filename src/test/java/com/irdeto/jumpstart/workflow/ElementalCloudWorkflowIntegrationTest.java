...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.ElementalCloudTest")
@TestProcessFileNames({ "com/irdeto/jumpstart/workflow/ElementalCloudTest.bpmn"})
public class ElementalCloudWorkflowIntegrationTest extends BaseProcessUnitTest {

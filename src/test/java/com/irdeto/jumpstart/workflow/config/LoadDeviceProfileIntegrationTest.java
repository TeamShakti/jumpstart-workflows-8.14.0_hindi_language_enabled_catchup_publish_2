...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.config.LoadDeviceProfile")
@TestProcessFileNames({
	"com/irdeto/jumpstart/workflow/config/LoadDeviceProfile.bpmn"
})

public class LoadDeviceProfileIntegrationTest extends BaseProcessUnitTest {

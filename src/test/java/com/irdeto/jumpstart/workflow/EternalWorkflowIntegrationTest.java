...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.EternalWorkflow")
@TestProcessFileNames({ "com/irdeto/jumpstart/workflow/EternalWorkflow.bpmn"})
public class EternalWorkflowIntegrationTest extends BaseProcessUnitTest {

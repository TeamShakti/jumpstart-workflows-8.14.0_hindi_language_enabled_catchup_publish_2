...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.taskhandler.AsyncMediaManager8ReadTest")
@TestProcessFileNames({
	"com/irdeto/jumpstart/workflow/taskhandler/AsyncMediaManager8ReadTest.bpmn"
	})
public class AsyncMediaManager8ReadTaskHandlerIntegrationTest extends BaseProcessUnitTest {

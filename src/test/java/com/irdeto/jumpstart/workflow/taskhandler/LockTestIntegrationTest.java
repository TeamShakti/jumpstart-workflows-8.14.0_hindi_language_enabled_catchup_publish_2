...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.LockTest")
@TestProcessFileNames({
	"com/irdeto/jumpstart/workflow/taskhandler/LockTest.bpmn"
	})
public class LockTestIntegrationTest extends BaseProcessUnitTest {

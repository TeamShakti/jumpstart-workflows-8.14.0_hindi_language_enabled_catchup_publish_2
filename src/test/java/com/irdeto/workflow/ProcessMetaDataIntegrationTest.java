...
@Test
@TestProcessId("com.irdeto.jumpstart.workflow.ProcessMetaData")
@TestProcessFileNames("ProcessMetaData.bpmn")
public class ProcessMetaDataIntegrationTest extends BaseProcessUnitTest {

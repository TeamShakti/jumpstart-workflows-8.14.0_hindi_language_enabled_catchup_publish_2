...
public class BrandPublishWrapper extends AbstractPublishWrapper<Brand> implements EntityWithGenreListPublishWrapper, EntityWithRatingsPublishWrapper, EntityWithSubscriptionPackageListPublishWrapper, EntityWithTvodCollectionListPublishWrapper {
	public BrandPublishWrapper() {
		super();
	}
	
	public BrandPublishWrapper(Brand approvedEntity) {
		super();

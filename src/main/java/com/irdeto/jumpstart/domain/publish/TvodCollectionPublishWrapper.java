...
public class TvodCollectionPublishWrapper extends AbstractPublishWrapper<TvodCollection> implements EntityWithGenreListPublishWrapper {
	public TvodCollectionPublishWrapper() {
		super();
	}
	
	public TvodCollectionPublishWrapper(TvodCollection approvedEntity) {
		super();

...
public class EventMetadataQA extends AbstractBaseMetadataQADecorator<Event> {
	public EventMetadataQA() {
		super();
	}
	
	public EventMetadataQA(String entityId, String entityType) {
		super();
	...
	public String getQAView() {
		return "Metadata QA Event View";
	}
	
	@Override
	@JsonIgnore
	public String getCorrectionView() {
		return "Metadata Event Edit View";
	}

...
/**
 * File Name: AbstractContentQADecorator.java
 * 
...
public abstract class AbstractContentQADecorator<T extends BaseMetadataWithContent> extends AbstractQADecorator<T> {
	@Override
	@JsonIgnore
	public boolean isQARequired() {
		return BooleanUtils.isNotTrue(getEntity().getContentApproved());
	}
}

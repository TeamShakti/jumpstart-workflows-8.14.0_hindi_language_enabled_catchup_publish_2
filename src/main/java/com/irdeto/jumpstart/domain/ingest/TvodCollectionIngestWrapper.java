...
public class TvodCollectionIngestWrapper extends EntityIngestWrapperWithGenre<TvodCollection> {
	...
	@Override
	@JsonIgnore
	protected List<ImageContent> getImageContentList(TvodCollection entity) {

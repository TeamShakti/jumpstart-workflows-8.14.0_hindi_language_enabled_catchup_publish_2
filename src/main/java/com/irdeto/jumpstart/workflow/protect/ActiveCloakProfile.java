...
public class ActiveCloakProfile extends AbstractCPSDRMProfile {

	private static final String SUBCONTENT_TYPE = "AC";

	@Override
	public String getProfileName() {
		return ProtectProfile.ProtectionType.ACTIVE_CLOAK.toString();
	}

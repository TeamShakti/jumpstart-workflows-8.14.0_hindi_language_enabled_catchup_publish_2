...
public class PlayReadyDRMProfile extends AbstractCPSDRMProfile {

	private static final String SUBCONTENT_TYPE = "IISSS";

	@Override
	public String getProfileName() {
		return ProtectProfile.ProtectionType.PLAY_READY_DRM.toString();
	}
	
	@Override
	public String getVideoCdnPrefix() {
		return DeviceProfileHelper.getCdnUrlPrefixIIS();
	}

	@Override
	public String getCdnUrlSuffix() {
		return SLASH + MANIFEST_SUFFIX;
	}
	...
	public String getSourceEncrypt(String cpsSourceURL, String m3u8Filename,
		...
		return cpsSourceURL + ismFilename;
	}
	
	@Override
	public List<String> getAdditionalSourceFiles(String filename) {
		List<String> additionalSourceFileList = new ArrayList<>();
		additionalSourceFileList.add(FileHelper.addHybridBaseURLAndPath(FileProtectHelper.getIsmFilename(filename), WorkflowHelper.TRANSCODED_TYPE));
		additionalSourceFileList.add(FileHelper.addHybridBaseURLAndPath(FileProtectHelper.getIsmcFilename(filename), WorkflowHelper.TRANSCODED_TYPE));
		return additionalSourceFileList;
	}
